...
if(isset($_POST['submit'])){
    ...
    $stmt = $conn->prepare("INSERT INTO todolist('id','task')");
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="w-full h-auto flex justify-center items-center p-1">
        <div class="w-[85%] h-auto bg-stone-200 flex justify-between items-center rounded-3xl">
            <input type="text" name="textbox" class="w-[85%] bg-stone-200 rounded-tl-3xl rounded-bl-3xl p-3 focus:outline-none"
