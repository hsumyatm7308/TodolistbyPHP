...
<!-- update to do  -->
<form action="complete.php" method="post" class="mt-3" enctype="multipart/form-data">
    ...
    <?php while ($row = $stmt->fetch()): ?>
        ...
        <div name="taskitems" class="w-full h-auto flex justify-center items-center p-1">
            ...
            <div class="w-[85%] h-auto bg-stone-200 flex justify-between items-center p-3">
                <span>
                    <i type="submit" name="complete" value="<?php echo $row["id"] ?>" class="fa-regular fa-circle-check"></i>
                    <span class="ml-1">
                        <?php echo $row['task'] ?>
                    </span>
                </span>
