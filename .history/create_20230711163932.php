...
In this updated code, I added a hidden input field (<input type="hidden">) dynamically inside the submit button (<button>) to store the ID of the task being edited. This ID will be sent as a $_POST parameter named edit-id.
