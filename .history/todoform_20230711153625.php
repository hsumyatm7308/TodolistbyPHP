    ...
    <div name="taskitems" class="w-full h-auto flex justify-center items-center p-1">
        <div class="w-[85%] h-auto bg-stone-200 flex justify-between items-center p-3">
            ...
            <div class="flex justify-center items-center">
                ...
                <!-- <a href="index.php?edit-task=<?php echo $row['id']; ?>" name="edit-task"> -->
                <button class="mr-4 editbtn" name="edit-task?<?php echo $row['id']; ?>" value="<?php echo $row['id']; ?>">
...
<script>
    ...
    for (var x = 0; x < editbtn.length; x++) {
        (function (index) {
            editbtn[index].addEventListener('click', function (event) {
                const submitBtn = document.getElementById('submitBtn');
                submitBtn.setAttribute('name', 'update');
                console.log(editbtn[index].value);
                
                const editTaskId = editbtn[index].value;
